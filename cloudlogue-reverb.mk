...
PROJECT = cloudlogue-reverb

UCXXSRC = cloudlogue-reverb.cpp
...
CXXOPT = -std=c++14 -fno-rtti -fno-exceptions -fno-non-call-exceptions -fno-use-cxa-atexit -ffunction-sections -fdata-sections -funroll-loops -ffast-math

LDOPT = -Xlinker --just-symbols=$(LDDIR)/main_api.syms -Wl,--gc-sections
...
package:
	@echo Packaging $(VERSION) for $(PLATFORM) to ./$(PKGARCH)
	@mkdir -p $(PKGDIR)
